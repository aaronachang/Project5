...
public class CritterWorldController implements Initializable {
    ...
    public void initialize(URL fxmlFileLocation, ResourceBundle resources) {
        ...
        critterSelect.getItems().add("assignment5.Algae");
        critterSelect.getItems().add("assignment5.Craig");
        critterSelect.getItems().add("assignment5.Critter1");
        critterSelect.getItems().add("assignment5.Critter2");
        critterSelect.getItems().add("assignment5.Critter3");
        critterSelect.getItems().add("assignment5.Critter4");
    }
    ...
    private void draw(Canvas canvas, int width, int height) {
        ...
        for (Critter c : Critter.getPopulation()) {
        	...
        	switch(c.viewShape()) {
        		...
        		default: gc.fillRect(startX + c.getX_coord()*SQ_SIZE, startY+c.getY_coord()*SQ_SIZE, SQ_SIZE, SQ_SIZE); break;
        	}
        }
